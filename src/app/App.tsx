              ...
              <li key={item.id}>
                <button
                  ...
                  className={`w-full text-left px-6 py-3 text-sm font-medium transition-colors ${
                    page === item.id ? "text-primary bg-secondary" : "text-foreground hover:bg-secondary"
                  }`}
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  {item.label}
                  ...
                  {(["materiais", "metodologia", "resultados"] as const).map((a) => (
                    <button
                      ...
                      className={`flex-1 py-2 text-sm font-medium rounded-md capitalize transition-all ${
                        aba === a ? "bg-white text-primary shadow-sm" : "text-muted-foreground hover:text-foreground"
                      }`}
                      style={{ fontFamily: "'DM Sans', sans-serif" }}
                    >
