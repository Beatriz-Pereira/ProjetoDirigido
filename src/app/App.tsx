...
const experimentos = [
    ...
    },
    {
        ...
        materiais: [
            ...
            "Fio de barbante ou nylon para conectar a amostra à cesta de carga",
        ...
        metodologia: [
            ...
            { texto: "Fixar a extremidade superior da tira a uma barra horizontal e conectar a extremidade inferior, por meio de um fio de barbante ou nylon, a uma pequena cesta destinada à aplicação de cargas.", img: imgResultado("esquema-de-ensaio.jpg") },
    ...
    },
    {
        ...
        metodologia: [
            { texto: "Antes da inserção no solo, fotografar as amostras para documentar o estado original.", img: imgResultado("amostras-iniciais-terra.jpg") },
